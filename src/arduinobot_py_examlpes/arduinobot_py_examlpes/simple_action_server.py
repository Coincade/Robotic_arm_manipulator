...
class SimpleActionServer(Node):
    def __init__(self):
        ...
        self._action_server = ActionServer(self,Fibonacci, 'fibonacci', self.goalCallback)
        self.get_logger().info("Simple Action Server has been started...")
    
    def goalCallback(self, goal_handle):
        self.get_logger().info("Executing goal...")
        self.get_logger().info(f"Goal request received with order: {goal_handle.request.order}")
