...
class TaskServer(Node):
    def __init__(self):
        ...
        self._action_server = ActionServer(self,ArduinobotTask, 'task_server', self.goalCallback)
    ...
    def goalCallback(self, goal_handle):
        ...
        self.get_logger().info(f"Goal request received with task number: {goal_handle.request.task_number}")
